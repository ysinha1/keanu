...
public abstract class DoubleVertex extends ContinuousVertex<DoubleTensor> implements DoubleOperators<DoubleVertex>, Differentiable {
    ...
    public DoubleVertex lambda(int[] outputShape, Function<DoubleTensor, DoubleTensor> op, Function<Map<Differentiable, DualNumber>, DualNumber> dualNumberCalculation) {
    ...
    public abstract DualNumber calculateDualNumber(Map<Differentiable, DualNumber> dualNumbers);
    ...
    public DoubleVertex plus(Vertex<DoubleTensor> that) {
