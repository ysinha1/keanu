...
public class DoubleUnaryOpLambda<IN> extends NonProbabilisticDouble {
    ...
    protected final Function<Map<Differentiable, DualNumber>, DualNumber> dualNumberSupplier;

    public DoubleUnaryOpLambda(int[] shape, Vertex<IN> inputVertex, Function<IN, DoubleTensor> op, Function<Map<Differentiable, DualNumber>, DualNumber> dualNumberCalculation) {
    ...
    public DoubleUnaryOpLambda(Vertex<IN> inputVertex, Function<IN, DoubleTensor> op, Function<Map<Differentiable, DualNumber>, DualNumber> dualNumberCalculation) {
